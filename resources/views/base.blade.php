...
<body>
    ...
    <footer>
        ...
        <div class="copyright">
            <p>Copyright {{ date('Y') }} &middot; <a href="{{ route('main.apropos') }}">Ocnamo Restaurant</a> .Tous droits Résevésmade by <b> <a href="https://mohamedelkashef.com "
                target="_blank"> Mohamed Elkashef</a> </b></p></p>
        </div>
